Organizers: Mina Aganagic,  Sujay Nair, and Peng Zhou

---

## 2024-01-29 — Spencer Tamagni — *UC Berkeley*
**Title:** Quasimaps with monopoles and nonabelian shift operators
...
## 2024-02-05 — Yegor Zenkevich — *UC Berkeley*
**Title:** Quantum toroidal algebras and spiralling branes
...
## 2024-02-12 — Andrey Smirnov — *UNC Chapel Hill*
...
## 2024-02-26 — Roger Casals — *UC Davis*
**Title:** Spectral Networks and Morse flow trees
...
## 2024-03-04 — Luca Iliesiu — *UC Berkeley*
**Title:** Supersymmetric indices from the gravitational path integral
...
## 2024-03-13 — Andrei Okounkov — *Columbia University*
**Title:** L-genera in enumerative problems
...
## 2024-03-18 — Dylan Butson — *University of Oxford*
**Title:** W-algebras, Yangians, and toric Calabi-Yau threefolds
...
## 2024-04-01 — Ahsan Khan — *IAS*
**Title:** Algebra of the Infrared with Twisted Masses
...
## 2024-04-08 — Vasily Krylov — *MIT*
**Title:** From geometric realization of affine Hecke algebras to character formulas.
...
## 2024-04-15 — David Rose — *UNC Chapel Hill*
**Title:** Towards a categorification of the Turaev--Viro TQFT
...
## 2024-04-22 — Andy Neitzke — *Yale*
**Title:** Abelianization of Virasoro conformal blocks
...
## 2024-04-29 — Ben Webster — *Perimeter Institute and University of Waterloo*
**Title:** The cotangent bundle of the Grassmannian as a Coulomb branch
...
## 2024-05-06 — Yehao Zhou — *IPMU*
**Title:** Type A deformed double current algebras, affine Yangians, rectangular W-algebras, and their coproducts

Abstract:
In this talk I will start with introducing a new presentation of deformed double current algebra of type \(gl_k\), denoted by \(A^{(k)}\), which is motivated from the study of M2 branes in the twisted M-theory. Then I will explain how to find an algebra embedding from \(A^{(k)}\) to the mode algebra of \(W^{(k)}_\infty\), which is a matrix-extended generalization of \(W_{1+\infty}\) algebra. The embedding is motivated from the M2 ending on M5 configuration. \(A^{(k)}\) can be "doubled" to get an algebra \(Y^{(k)}\). When \(k\) is not equal to 2, we can show that \(Y^{(k)}\) is isomorphic to affine Yangian of type \(A_{k-1}\). Conjecturally, such isomorphism also holds for \(k=2\). I will also discuss various coproducts of these algebras along the way, which are motivated from the fusions of branes.
